...
public class BebopVideoView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public Image displayFrame(ARFrame frame, boolean screenshot) {
        mReadyLock.lock();
...
//                frameoutput = mMediaCodec.getOutputBuffer(outIndex);
//                Log.d(TAG,"output" + frameoutput.toString());
...
//                    Log.d(TAG,String.valueOf(frameoutput.getFormat()));
//                    Log.d(TAG,String.valueOf(frameoutput.getHeight()));
//                    Log.d(TAG,String.valueOf(frameoutput.getWidth()));

//                        MediaFormat mmediaFormat = mMediaCodec.getOutputFormat();
//                    Log.d(TAG, mMediaCodec.getOutputFormat().toString());

//                    ByteBuffer buffer = frameoutput.getPlanes()[0].getBuffer();
